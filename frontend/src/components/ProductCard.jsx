...
const ProductCard = ({ product }) => {
    //product derive from product object passed as prop  to the product component, from homepage useEffect
    const [updatedProduct, setUpdatedProduct] = useState(product); // product is from useProductStore integrated b
